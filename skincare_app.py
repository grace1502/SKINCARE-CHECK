    ...
    <style>
        * {
        ...
        body {
            ...
            background: linear-gradient(rgba(232, 213, 242, 0.9), rgba(221, 160, 221, 0.9)), 
                        url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 800"><rect fill="%23F8BBD9" width="1200" height="800"/><g opacity="0.8"><circle cx="200" cy="200" r="100" fill="%23FFB6C1"/><circle cx="800" cy="300" r="120" fill="%23DDA0DD"/><circle cx="1000" cy="600" r="80" fill="%23E8D5F2"/><circle cx="400" cy="500" r="90" fill="%23FFC0CB"/></g></svg>');
